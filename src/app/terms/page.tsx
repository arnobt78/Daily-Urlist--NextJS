      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg">
          <p className="text-lg text-gray-600 mb-6">
            By using The Urlist, you agree to these terms of service. Please read them carefully.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Acceptance of Terms</h2>
          <p className="text-lg text-gray-600 mb-6">
            By accessing and using The Urlist, you accept and agree to be bound by the terms and conditions of this agreement.
          </p>
          ...
          <ul className="list-disc list-inside text-lg text-gray-600 mb-6 space-y-2">
            ...
            <li>You must not share harmful or malicious content</li>
          ...
          <p className="text-lg text-gray-600 mb-6">
            The Urlist is provided "as is" without any warranties. We are not responsible for any damages that may occur through the use of our service.
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Contact</h2>
          <p className="text-lg text-gray-600">
            For any questions regarding these terms, please contact us at arnob_t78@yahoo.com
          </p>
        </div>
      </div>
    </div>
