...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16 px-4 sm:py-20 sm:px-6">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600">
              The Daily Urlist
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                href="/new"
                className="bg-blue-600 hover:bg-blue-700 text-white text-lg font-semibold px-8 py-3 rounded-xl shadow-md hover:shadow-xl transition-all duration-200 w-full sm:w-auto"
              >
                Create New List
              </Button>
              <Button
                href="/lists"
                variant="outline"
                className="text-gray-700 border-gray-300 hover:bg-gray-50 text-lg px-8 py-3 rounded-xl w-full sm:w-auto"
              >
                View My Lists
              </Button>
            </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-6 sm:p-8 rounded-2xl border border-gray-200/80 bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:border-blue-100"
              >
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center p-4 sm:p-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-lg sm:text-xl font-semibold mx-auto mb-4">
                1
              </div>
            ...
            <div className="text-center p-4 sm:p-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center text-lg sm:text-xl font-semibold mx-auto mb-4">
                2
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                Add URLs
            ...
            <div className="text-center p-4 sm:p-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-lg sm:text-xl font-semibold mx-auto mb-4">
                3
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                Share
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:py-20 sm:px-6 bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50">
